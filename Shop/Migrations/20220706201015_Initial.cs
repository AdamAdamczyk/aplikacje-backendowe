        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Games_Authors_AuthorsId",
                        column: x => x.AuthorsId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Games_GameShops_GameShopsId",
                        column: x => x.GameShopsId,
                        principalTable: "GameShops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Games_Producers_ProducersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Games_AuthorsId",
                table: "Games",
                column: "AuthorsId");

            migrationBuilder.CreateIndex(
                name: "IX_Games_GameShopsId",
                table: "Games",
                column: "GameShopsId");

            migrationBuilder.CreateIndex(
                name: "IX_Games_ProducersId",
                table: "Games",
                column: "ProducersId");
        }
